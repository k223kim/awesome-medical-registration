...
MAX_SLICE = 64
DATAPATH = "/home/fr2zyroom/kaeunkim/transmorph_inference_opp/voxelmorph_diff/test"
SAVEPATH = "/home/fr2zyroom/kaeunkim/SwinIR_input_opp/voxelmorph_diff/test"
    ...
    for root, _, images in os.walk(data_path):
        for image in tqdm(images):
            if image.startswith('aorta'):
                ...
                pre_name = 'pre_'+patient_num+'_prediction.npz'
